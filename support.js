// GENERATED from dc-runtime/src/*.ts вЂ” do not edit. Rebuild with `cd dc-runtime && bun run build`.
"use strict";
(() => {
  ...
  function createComponentFactory(registry, ensureFetched) {
    ...
    class StreamableComponent extends React.Component {
      constructor(props) {
        ...
        /** Snapshot of the registry's streaming flags taken at render time вЂ”
        ...
        /** Per-instance constructor error вЂ” kept here (not on the registry entry)
       ...
       *  over its initial state вЂ” used both at mount and on hot-swap. */
      ...
      /** The props the author's logic + template see вЂ” internal __-prefixed
       *  wiring stripped. */
      __userProps() {
  ...
  function init() {
    ...
    const api = {
      ...
      /** Name of the component currently mounted as the page root вЂ” DC tools
       *  push their template-stream here when targeting "the open page". */
      __dcRootName: () => rootName,
      /** Editor bridge вЂ” the encoded, `data-dc-tpl`-annotated template source.
      ...
      /** Editor bridge вЂ” the *original* (decoded) template source. */
